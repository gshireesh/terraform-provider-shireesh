...
const goRoleTemplateV2 = `// Code generated by componentgen; DO NOT EDIT.
 ...
 import (
 	...
 	"google.golang.org/grpc/metadata"
 	{{- end }}
 	{{- if NeedsTypes .Spec }}"github.com/hashicorp/terraform-plugin-framework/types"{{- end }}
 )
...
func funcMap() template.FuncMap {
	return template.FuncMap{
		...
		"DSAttr":            dsAttrCode,
		"EphAttr":           ephAttrCode,
		"NeedsTypes":        specNeedsTypes,
	}
}

func specNeedsTypes(s component.Spec) bool { return fieldsNeedTypes(s.Fields) }

func fieldsNeedTypes(fields []component.Field) bool {
	for _, f := range fields {
		switch f.Type {
		case "list":
			if f.ElemType != "object" && f.ElemType != "" {
				return true
			}
			if fieldsNeedTypes(f.Fields) {
				return true
			}
		case "object":
			if fieldsNeedTypes(f.Fields) {
